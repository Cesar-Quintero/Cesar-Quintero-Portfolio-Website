# Portfolio Website : <a target="_blank" href="https://realcesarquintero.com/">Visit Here</a>

<a target="_blank" href="https://realcesarquintero.com/">
<img src="RMimages/scrnsht1.jpeg" width="100%" alt="Portfolio"/>
</a>
...
My next steps for improving this project would be to create a double column section for my "projects" section. 

## Lessons Learned:

Responsiveness. Being able to use CSS flexbox to create fluid, responsive containers that adapt to a variety of devices from mobile, tablet, to large monitors.
